...
- Cette version nécessite des DLL de runtime C mises à jour (libc-0.5.1) du site
  ...
  même répertoire que l'exécutable de Firefox ou ailleurs dans votre LIBPATH.
...
-------------------------------------
   ...
   téléchargez le fichier .zip et suivez ces étapes :
     ...
     typiquement firefox-os2-*.zip où "*" est remplacé par la version de Firefox.
     ...
     "firefox" sous l'emplacement que vous indiquez, c-à-d. 
        unzip firefox-os2-1.0.1.zip -d c:\firefox-1.0.1
     décompressera Firefox dans c:\firefox-1.0.1\firefox.
...
- set MOZILLA_USE_EXTENDED_FT2LIB=T
  ...
  spéciales de Firefox pour manipuler les caractères unicode.
...
leur mise en page.
Cela affecte également le rendu dans Firefox.
